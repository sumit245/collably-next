          ...
          <div className="footer-item">
            <div className="f-1">
              ...
              <ul className="icon-btn">
                ...
                <li>
                  <Link href="#"><Image src="/images/002-instagram.png" alt="Twitter" width={24} height={24} className="icon-img" />Instagram</Link>
                </li>
                <li>
                  <Link href="#"><Image src="/images/003-youtube.png" alt="Instagram" width={24} height={24} className="icon-img" />Youtube</Link>
                </li>
                <li>
